...
import {AstemsTestService} from './astemstest.service';


@Component({
  selector: 'app-astemstest',
  templateUrl: './astemstest.component.html',
  styleUrls: ['./astemstest.component.scss']
})

export class AstemstestComponent implements OnInit {
  ...
  constructor(
    ...
    private service: AstemsTestService,
